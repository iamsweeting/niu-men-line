...
class HostPython3Recipe(Recipe):
    ...
    # 本地覆盖：新版 p4a（v2026.05.09）默认 hostpython3 为 3.14.2，但 Kivy 2.2.0
    # 只能在 <=3.12 上构建；这里把 hostpython3 版本改为 3.11.5，与构建 Python
    # （docker_build.sh 钉的 python3==3.11.5）保持一致，其余逻辑与上游完全一致。
    version = "3.11.5"
